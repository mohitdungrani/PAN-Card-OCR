...
def parse_args():
	...
	parser.add_argument('--weights', dest="DARKNET_WEIGHTS", default="yolo-obj_30000.weights", help="Weights for Darknet")
...
if DARKNET:
	...
	DARKNET_IMAGE_FILE = ("input")
	DARKNET_DATA_FILE = ("data/obj.data")
	DARKNET_CFG_FILE  = ("yolo-obj.cfg")
	DARKNET_WEIGHTS   = ("backup/yolo-obj_30000.weights")
